...
import { ExternalLink, Package, ShoppingBag, Calendar, Clock, MoreVertical, FileText, RefreshCw, Mail, Truck, X } from "lucide-react";
...
export default function OrdersTab({ user }: { user: any }) {
  ...
  const handleTrack = (order: any) => {
    if (order.tracking_url) {
      ...
      toast.info('Tracking not available for this order.');
    }
  };
